...
namespace UserApp.Application.Common.Models
{
    /// <summary>
    ...
    public class ServiceError
    {
        ...
        public static ServiceError DateTimeFormatError => new ServiceError("Date format is not true. Date format must be like yyyy-MM-dd (2019-07-19)", 501);

        public static ServiceError SystemError => new ServiceError("System error", 500);
